...
\begin{alignat*}{3}
  ...
  & \grafte~\gamma~\delta~(\mvar~i)   && ~=~ \monoe~\rlap{$(\infleq \, \reflleq)~(\graftin~\delta~i)$}\\
...
\begin{alignat*}{5}
  ...
  &                                    &&        &&     && \quad\quad \reflectc~(\monoene~(\infleq \, \mu')~(\mvarne~\tops)))))\\[.5\baselineskip]
...
\end{alignat*}
By reflecting assumptions into the canonical model, we obtain that value environments are both non-modally and modally reflexive:
\begin{alignat*}{2}
